...
const invoiceSchema = new mongoose.Schema(
  {
    ...
    // Traceability to originating business object
    linkedAppointment: { type: mongoose.Schema.Types.ObjectId, ref: "Appointment" },
    linkedCart: { type: mongoose.Schema.Types.ObjectId, ref: "Cart" },
    linkedDaycare: { type: mongoose.Schema.Types.ObjectId, ref: "CareCustomer" },
  },
  { timestamps: true }
);
