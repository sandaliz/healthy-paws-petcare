// Controllers/DailyLogsControllers.js (ESM)
import mongoose from "mongoose";
import DailyLog from "../Model/DailyLogsModel.js";
...
export const getLogsByAppointment = async (req, res) => {
  try {
...
export const updateDailyLog = async (req, res) => {
  try {
    ...
    if (updateData.appointment) {
      const appointmentExists = await CareCustomer.findById(
    ...
    const dailyLog = await DailyLog.findByIdAndUpdate(id, updateData, {
      new: true,
      runValidators: true,
    }).populate("appointment");
