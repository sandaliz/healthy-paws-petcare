  ...
  return (
    <>
      <div className="bf-overview-head">
        <h2>Finance Overview</h2>
        <button className="bf-overview-btn-export" onClick={exportPDF}>
          Export PDF
        </button>
      </div>
...
<div className="bf-overview-grid-kpis">
  <Card className="bf-overview-kpi">
  ...
  <Card className="bf-overview-kpi">
    ...
    <div className="bf-overview-kpi-icon customers">
      ...
      <div className="bf-overview-charts">
        <div className="bf-overview-chart" ref={revenueRef}>
          <div className="bf-overview-chart-header">
            <div className="bf-overview-chart-title">Revenue (last 30 days)</div>
          </div>
          <ResponsiveContainer width="100%" height={260}>
            <LineChart data={revenueSeries}>
              <XAxis dataKey="date"
        ...
        <div className="bf-overview-chart" ref={incomeExpenseRef}>
        ...
        <div className="bf-overview-chart" ref={payMethodsRef}>
        ...
        <div className="bf-overview-panel">
        ...
        <div className="bf-overview-panel">
          <div className="bf-overview-panel-title">Notifications</div>
          <ul className="bf-overview-notifs">
            <li>{notifications.pendingRefunds} pending refund approvals</li>
            <li>{notifications.overdueInvoices} overdue invoices</li>
            <li>{notifications.lowCoupons} coupon templates low on stock</li>
          </ul>
